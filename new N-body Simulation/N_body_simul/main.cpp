...
void parser(istream& is) {
	...
	for (string line; getline(is, line); ) {
		...
		for (int i = 0; i < words.size(); ++i)
		{
			...
			else if (words[0] == "ru")/////////////////////////////////////////////////////////////////////////////////////////////수정
			{
				timer->mkTimeArr(stod(words[1]));
				for (map<int, Particle>::iterator it = all.begin(); it != all.end(); it++)
				{
					int num = it->first;
					Particle pTemp = it->second;

				}
			}
			else if (words[0] == "rv")/////////////////////////////////////////////////////////////////////////////////////////////수정
			{
